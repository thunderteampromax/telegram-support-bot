...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "Hey There I can Promote Your YouTube Channel And Get More Views + Subscribers For Free Just Send me Your Details :- Channel Name :- Channel Link :- Email :- Your Explanation :- ")
